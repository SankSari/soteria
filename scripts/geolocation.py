...
def getNearbyPlaces(place):
    ...
    url = 'https://maps.googleapis.com/maps/api/place/nearbysearch/json?location=' + lat + \
        ',' + lon + '&radius=1000&type=' + place + \
        '&key=AIzaSyAcuwTIAN38WlfEwQqxYdLhLWN476BFExI'
    ...
    for data in jdata['results']:
        ...
        dlon = float(jdata['results'][count]['geometry']['location']['lng'])
        print(jdata['results'][count]['geometry']['location'])
